        ...
        >
          ...
          >
            <div className="px-5 md:px-6 pt-5 pb-3 border-b border-gold/15 flex items-start justify-between gap-4">
              <div>
                <h3 className="font-display text-lg md:text-xl text-gold-gradient text-shadow-gold">
                  {title}
                </h3>
              ...
              <button
                onClick={onClose}
                aria-label="关闭"
                className="h-8 w-8 rounded-lg bg-secondary/60 grid place-items-center text-muted-foreground hover:text-bone focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                <X size={16} />
              </button>
            </div>
            <div className="flex-1 overflow-y-auto scrollbar-thin px-5 md:px-6 py-4">
              {children}
            </div>
          </motion.div>
        </motion.div>
